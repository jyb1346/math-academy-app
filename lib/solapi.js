...
const KAKAO_PFID = process.env.SOLAPI_KAKAO_PFID;
const KAKAO_TEMPLATE_ID = process.env.SOLAPI_KAKAO_TEMPLATE_ID;

export function getSolapiAuthHeader() {
  if (!API_KEY || !API_SECRET) {
    throw new Error('Solapi API 인증 키가 환경 변수(SOLAPI_API_KEY, SOLAPI_API_SECRET)에 설정되지 않았습니다.');
  }
