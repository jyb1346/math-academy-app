      ...
      <header className="bg-blue-600 text-white py-6 px-4 shadow-md">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          ...
          <button
            ...
            className="bg-blue-700 hover:bg-blue-800 text-xs px-3 py-2 rounded-lg transition font-bold"
          >
            로그아웃
          </button>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 mt-8 space-y-8">
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          {attendanceList.length === 0 ? (
            <p className="text-gray-500 text-center py-4 text-sm">아직 기록된 출결 정보가 없습니다.</p>
          ) : (
