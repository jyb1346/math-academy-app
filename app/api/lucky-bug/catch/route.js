...
import { catchLuckyBug, checkIfUserIsJangTeacherOrStudent } from '@/lib/luckyBugService';

// POST /api/lucky-bug/catch — 학생 전용, 벌레 포획 시도
export async function POST(req) {
  ...
  const result = await catchLuckyBug(req, eventId, user.id, user.name);
