/**
 * 🐛 20종 벌레 도감 마스터 카탈로그
 * - 5개 등급: COMMON(일반 6종), RARE(레어 5종), EPIC(에픽 4종), LEGENDARY(전설 3종), BOSS(보스 2종)
 */
...
export const BUG_CATALOG = [
  ...
  // 🔵 2. RARE (레어 - 5종)
  {
    ...
    emoji: '🪙',
    tier: 'RARE',
    desc: '온몸이 눈부신 황금으로 도금된 전설의 길조. 품수학 최고의 마스코트!',
    defaultSpeed: 'FAST',
    escapeGimmick: true,
    auraClass: 'bg-yellow-400/70',
  ...
  },
  {
    ...
    emoji: '❄️',
    tier: 'RARE',
    desc: '차가운 냉기를 뿜어내며 날아다니는 시원한 여름의 매미.',
    defaultSpeed: 'NORMAL',
    escapeGimmick: false,
    auraClass: 'bg-sky-400/70',
  ...
  },
  {
    ...
    emoji: '⚡',
    tier: 'RARE',
    desc: '지그재그로 번개 치듯 질주하는 초고속 벌레. 눈 깜짝할 사이에 사라집니다.',
  ...
  },
  {
    ...
    emoji: '🍃',
    tier: 'RARE',
    desc: '화면 배경과 똑같이 위장하는 은신술의 달인. 날카로운 관찰력이 필요합니다.',
    defaultSpeed: 'NORMAL',
    escapeGimmick: true,
    auraClass: 'bg-emerald-600/60',
  ...
  },
  {
    ...
    emoji: '🔮',
    tier: 'EPIC',
    desc: '포획하려는 순간 화면 모서리로 웜홀을 열고 순간이동하는 신비한 거미.',
    defaultSpeed: 'FAST',
    escapeGimmick: true,
    auraClass: 'bg-purple-600/80',
  ...
  // 🟡 4. LEGENDARY (전설 - 3종)
  {
    ...
    emoji: '🌈',
    tier: 'LEGENDARY',
    desc: '일곱 빛깔 찬란한 무지개 오라를 두른 세계 최강의 장수풍뎅이.',
    defaultSpeed: 'EXTREME',
    escapeGimmick: true,
    auraClass: 'bg-gradient-to-r from-pink-500 via-amber-400 to-sky-400 opacity-90',
  ...
  },
  {
    ...
    emoji: '🪐',
    tier: 'LEGENDARY',
    desc: '우주 깊은 곳에서 별똥별 꼬리를 달고 날아온 외계 생명체 벌레.',
    defaultSpeed: 'EXTREME',
    escapeGimmick: true,
    auraClass: 'bg-violet-600/90',
  ...
  },
  {
    ...
    emoji: '🐲',
    tier: 'LEGENDARY',
    desc: '전설 속 붉은 용의 숨결을 품은 고대 비행 생명체. 마스터 헌터의 상징!',
    defaultSpeed: 'EXTREME',
    escapeGimmick: true,
    auraClass: 'bg-rose-600/90',
  ...
  // 👑 5. BOSS (보스 레이드 - 2종)
  {
    ...
    emoji: '👑',
    tier: 'BOSS',
    desc: '반 전체가 협동하여 HP를 깎아야 잡히는 거대 레이드 보스! (1인당 타격 제한)',
    defaultSpeed: 'FAST',
    escapeGimmick: false,
    auraClass: 'bg-rose-700/90',
  ...
  },
  {
    ...
    emoji: '👹',
    tier: 'BOSS',
    desc: '전교생 총력전 전용 초대형 보스! 분노 모드와 그로기 페이즈를 돌파하라!',
    defaultSpeed: 'FAST',
    escapeGimmick: false,
    auraClass: 'bg-red-800/90',
